...
function App() {
	...
	return (
		<div className="text-black" style={{backgroundImage:'URL(https://cdn.pixabay.com/photo/2021/05/28/11/23/flag-6290584_1280.jpg)',backgroundSize:'cover'}}>
			<div className="flex items-center justify-between flex-row px-4 py-2">
				<h1 className="text-5xl font-bold">DApp</h1>
				<ConnectButton />
			</div>
			{
				screen === 'home' ? (
					<div className="flex flex-col gap-4 items-center justify-center min-h-screen">
						<h1 className="text-2xl font-extrabold" style={{ fontSize: '3rem', fontWeight: '800' }}>WELCOME</h1>
						{
							address ? (
